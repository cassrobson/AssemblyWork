...
ADD	R0, R0, #4 //incremented by 4 instead of 2
ADD	R1, R1, #4
LDR	R2, [R0]
STR	R2, [R1] //should be stored in R1 instead of R2
...
Vec2:
.word	0, 0, 0 // 3 words x 4 bytes, must be assigned to 0 because of .bss
