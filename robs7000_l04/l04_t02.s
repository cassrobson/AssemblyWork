...
STRB r0, [r1, r3] //write character to memory buffer
ADD r3, #1 //increment character count
CMP r3, #256 //check if memory buffer is full
BEQ exit //Jump to exit if memory buffer is full
