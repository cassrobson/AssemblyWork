...
LDR r0, =Data //load start of Data array
LDR r1, =_Data //load end of Data array
STMFD SP!, {r1} //Push the address of end of array
STMFD SP!, {r0} //Push the address of start of array
BL MinMax
ADD SP, SP, #8 //release memory

STR R2, [r0, #4] //store the min and max values from the subroutine
STR R3, [r0, #8]
